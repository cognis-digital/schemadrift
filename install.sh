#!/usr/bin/env sh
# Universal installer for schemadrift. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/schemadrift.git"
echo "Installing schemadrift ..."
...
echo "Done. Run: schemadrift --help"
