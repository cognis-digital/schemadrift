"""Native cognis-connect emit for schemadrift — forward findings to any platform.

Maps schemadrift's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    schemadrift ... --format json | schemadrift-emit --to stix
    schemadrift-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
