"""SCHEMADRIFT core — Schema-change detector and data-contract tests."""
...
RULES = [
    ("SCH-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("SCH-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("SCH-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
